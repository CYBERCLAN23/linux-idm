# Linux IDM - Internet Download Manager 🚀

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Platform: Linux](https://img.shields.io/badge/Platform-Linux-orange.svg)](https://www.linux.org/)

**Linux IDM** is a modern, high-speed, and feature-rich Internet Download Manager designed specifically for the Linux community. Built with performance and aesthetics in mind, it provides a seamless experience for managing all your downloads in one place.
...
- **📦 Universal Packages**: Available as AppImage, `.deb`, and `.rpm`.
...
We love contributions! Whether it's fixing a bug, adding a feature, or improving documentation, please see our [Contributing Guidelines](CONTRIBUTING.md).
...
- **Support**: [psychomarlon6@gmail.com](mailto:psychomarlon6@gmail.com)
